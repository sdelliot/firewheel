...
"""
    ...
    def test_upload_new_time_same_hash(self):
        ...
        pre_time = datetime.fromtimestamp(os.path.getmtime(self.image1_path), UTC)
        ...
        post_time = datetime.fromtimestamp(os.path.getmtime(self.image1_path), UTC)
    ...
    def test_upload_old_time_new_hash(self):
        ...
        second_time = datetime.fromtimestamp(os.path.getmtime(self.image1_path), UTC)
    ...
    def test_upload_revert_same_file(self):
        ...
        rev_time = datetime.fromtimestamp(os.path.getmtime(self.image1_path), UTC)
