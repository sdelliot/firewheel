...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in firewheel/lib/grpc/firewheel_grpc_pb2_grpc.py depends on'
...
def add_FirewheelServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('firewheel_grpc.Firewheel', rpc_method_handlers)
